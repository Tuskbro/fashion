...
export default function SignUp({navigation}: {navigation:StackNavigationProps<Routes,"SignUp">}) {
  const theme : ITheme = useSelector((state: RootStateOrAny)=>state.themeReducer.theme );
  const styles = getStyles(theme);
  return (
    <Container  footer={
      <SocialLogin  label='Have an account? '
        button={
          <Button 
            label='Sign In here'
            variant='link'
      ...
      <View style={styles.container}>
        ...
        <View>
          ...
          <TextInput placeholder='Repeat your password' icon='lock'></TextInput>
